...
AddressSanitizer. The `target_and_report` target exercises URL parsing,
IPv6 classification, address permission policy, and redaction for arbitrary
UTF-8, plus the production report size bound, typed JSON parser, schema check,
...
cp fuzz/seeds/*.txt fuzz/corpus/target_and_report/
